# Generated by Django 3.2.3 on 2021-06-13 06:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('RED', 'RED'), ('GREEN', 'GREEN')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='XL', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('available_colours', models.ManyToManyField(default='defaultM2M', to='cart.ColourVariation')),
                ('available_sizes', models.ManyToManyField(to='cart.SizeVariation')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_products', to='cart.category')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
